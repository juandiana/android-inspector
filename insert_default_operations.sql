...
INSERT INTO data_source_types (id, name, extractor_name) values ('data_source_type_1', 'Application','ApplicationExtractor');
INSERT INTO required_params (data_source_type_id, param_name) values ('data_source_type_1', 'package_name');
INSERT INTO operations (id, data_type_id, data_source_type_id, inspector_name) values ('operation_1', 'data_type_1', 'data_source_type_1', 'EmailMessageInspector');
